...
export default function WomensMinistry() {
  return (
    <div className="grid md:grid-cols-2 gap-8 items-center">
      ...
      >
        <h2 className="text-3xl font-bold text-white mb-4">Women's Ministry</h2>
        ...
        <ul className="space-y-4 list-disc pl-5">
          <li>
            <h3 className="text-xl font-semibold text-blue-400">Bible Study Groups</h3>
            <p className="text-gray-300">Weekly gatherings for spiritual growth and fellowship</p>
          </li>
          <li>
            <h3 className="text-xl font-semibold text-blue-400">Prayer Circles</h3>
            <p className="text-gray-300">Supporting one another through prayer and encouragement</p>
          </li>
          <li>
            <h3 className="text-xl font-semibold text-blue-400">Outreach Programs</h3>
            <p className="text-gray-300">Serving the community through various initiatives</p>
          </li>
        </ul>
      </motion.div>
      <motion.div
